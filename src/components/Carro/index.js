...
export const Carro = ({
    ...
    ////FUNCION ELIMINAR
    /*
        Lo logre hacer visitando unas paginas 
        https://help.shopify.com/es/manual/online-sales-channels/buy-button/edit-delete

        y unos videos del curso:
        https://www.youtube.com/channel/UCXR7VjA26PcHP3vb6F2X3VQ   
     */
    ...
    const eliminar = (x) => {
        ...
        if(window.confirm('Se eliminaria la siguiente peticion, ¿Desea continuar?')){
            eliminarProducto(x)
        }
